...
- **Entity** (`knowledge_role: entity`): a uniquely identifiable person, organization, product, place, system, or tool. Default OKF `type`: `Entity` (prefer specifics such as `Person` or `Organization` when clear).
