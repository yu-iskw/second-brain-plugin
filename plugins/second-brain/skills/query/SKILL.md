...
2. Search canonical pages and follow useful Markdown links (relative links per `governance/schema.md`).
...
5. Cite knowledge pages with relative Markdown links per `governance/schema.md`.
