...
6. Require `knowledge-verifier` `PASS` after every **content** mutation phase (ingest integration, repair, synthesize). Log/ledger-only early stops use verification `N/A` and do not need mutation PASS.
