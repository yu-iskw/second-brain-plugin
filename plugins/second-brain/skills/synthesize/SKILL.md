...
Follow the integrator `synthesize` contract and `AGENTS.md` invariants. Update the index and log, then require `wiki-verifier` (`mutation` mode) to pass against okf-core and second-brain-governed profiles.
